#!/bin/bash
#SBATCH --job-name=qevasion_large
...
CONFIGS=(
  configs/roberta_large_task1.yaml
  configs/roberta_large_task2.yaml
  configs/deberta_v3_large_task1.yaml
  configs/deberta_v3_large_task2.yaml
  configs/deberta_xlarge_task1.yaml
  configs/deberta_xlarge_task2.yaml
)
